...
# ====== 改成你的两张“未阈值 SDM-Z 图” ======
A_PATH = Path(r"D:\SDM_overlap\r_F_top10%\all2_MyTest_z.nii.gz")          # all-sample
B_PATH = Path(r"D:\SDM_overlap\r_F_top10%\health2_withsiripada_MyTest_z.nii.gz")               # healthy-only
# ============================================
TOP_PCT = 10  # Top 10%
